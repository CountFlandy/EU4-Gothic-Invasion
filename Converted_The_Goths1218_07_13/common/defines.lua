...
NDiplomacy = {
	...
	HRE_VOTE_TOO_SMALL = -5,
	HRE_VOTE_BIG_COUNTRY = 15,
	HRE_VOTE_VERY_BIG_COUNTRY = 25,
	HRE_VOTE_NON_MEMBER = -50,
	HRE_VOTE_SAME_CULTURE_GROUP = 30,
	...
	GRANT_ELECTORATE_INFLUENCE = 2,					-- The amount of AI Grant Electorate gives.
	GRANT_FREECITY_INFLUENCE = 2,					-- The amount of IA Grant Free Gity gives.
	...
	AUTODIPLO_TARGET_SUBJECTS_HOPELESS_LIMIT = -190,
	...
	AUTODIPLO_TARGET_THREATS_IMPROVECAP = 100
},
...
NCountry = {
	...
	ESTATE_PROVINCE_HAPPINESS_CHANGE_MAX_NEG = 40,	-- Loyalty cannot change more than this from a single province revoke
	...
	--SUBJECT_MAX_RANK = 2,						-- max government rank of subjects #Old
	...
	RANDOM_LUCKY_TECH_WEIGHT = 0,					-- Multiplier on penalty given to slower tech group nations when rolling for random lucky (higher = more penalty)
	RANDOM_LUCKY_SLOW_TECH_PENALTY = 0,			-- Extra penalty on tech groups with more than 75% penalty when rolling for random lucky (lower = more penalty)
	...
	MAX_ACTIVE_POLICIES = 6,						-- how many active policies at once.
	MINIMUM_POLICY_TIME = 4,						-- how many years minimum for a policy
	POLICY_COST = 1,								-- Monthly cost per policy
	MIN_FEDERAL_AUTHORITY = -100,					-- federal authority cannot go lower than -100
	MAX_WAR_EXHAUSTION = 30,				-- Because you cant die quick enough fucker
	VICTORY_CARD_DECAY_MONTHS = 120,		-- 20 years to lose all score.
	VICTORY_CARD_INCREASE_MONTHS = 120,		-- 20 years to gain all score.
	...
	PIETY_PERCENTAGE_AT_NEW_RULER = 0,			-- percentage of piety kept at new ruler.
	...
	ADVISOR_CUT_OFF_AGE = 25, 						-- _CDEF_ADVISOR_CUT_OFF_AGE = 10,
	...
	MERCHANT_REPUBLIC_SIZE_LIMIT = 25,
	...
	PS_BUY_IDEA = 360,
	PS_BUY_NATIVE_ADVANCEMENT = 400,
	PS_BUY_RELIGIOUS_REFORM = 0,
	PS_ADVANCE_TECH = 600,
	PS_BOOST_STABILITY = 100,
	PS_BUY_GENERAL = 40,
	PS_BUY_ADMIRAL = 40,
	PS_BUY_CONQUISTADOR = 40,
	PS_BUY_EXPLORER = 40,
	PS_ASSAULT = 0,
	...
	PS_DEMAND_NON_WARGOAL_PEACE_PRIMITIVES = 15,
	...
	PS_IMPROVE_PROVINCE_CAPITAL_DISCOUNT = 0.08,
	PS_SET_PRIMARY_CULTURE = 100,
	PS_ADD_ACCEPTED_CULTURE = 75,
	PS_REMOVE_ACCEPTED_CULTURE = 25,
	...
	STRENGTHEN_GOVERNMENT_REPUBLICAN_TRADITION = 4,
	...
	CLAIM_THRONE_PRESTIGE_PENALTY = -10.0,			-- Prestige penalty when claiming throne
	BREAK_VASSAL_PRESTIGE_PENALTY = -15.0,			-- Prestige penalty when break vassalisation
	...
	CLAIM_LOSE = 20,								-- how many years until a claim is lost.
	...
	ABANDON_IDEAGROUP_REFUND = 0.25,				-- The part of the idea group spent that will be refunded upon abandonment.
	...
	MAX_QUEEN_AGE = 40,								-- You can't get a queen/prince older than this
	...
	MIGRATION_BOOST = 80,							-- How many points given when migrating.
	...
	LIBERTY_DESIRE_GREAT_POWER_VASSAL = 40,			-- Liberty desire from vassal having more than 300 development
	LIBERTY_DESIRE_HORDE = 5,						-- Liberty desire from vassal being a horde
...
NEconomy = {
	...
	GOLD_MINE_SIZE_PRIMITIVES = 20,					-- Gold income for very slow techgroups
	...
	COLONY_MIN_AUTONOMY = 30,						-- Colonial cores always have at least this much autonomy
...
NMilitary = {
	...
	REBEL_RELOCATION_DISTANCE_MAX = 400,					-- The maximum distance rebels will relocate to.
	...
	CAV_SUPPRESSION = 0.30,						-- The amount of reduction to unrest for each friendly cavalry regiment in a province
...
NAI = {
	...
	DIPLOMATIC_ACTION_CRUSADE_POWERBALANCE_FACTOR = 80, --AI scoring for calling crusade on power balance threat.
	...
	MISSION_PICK_CHANCE = 45, -- Monthly chance of AI picking a mission if it lacks one (of 100)
	...
	DIPLOMATIC_ACTION_BUILD_SPY_NETWORK_RIVAL_FACTOR = 50, -- Only applied if AI has espionage ideas
...
NGraphics = {
	...
	MIN_PROVINCES_FOR_NAME_ON_MAP = 1,
...
NReligion = {
	...
	SACRIFICE_COOLDOWN = 1,									-- Years before you can sacrifice a ruler/heir from same country
	...
	MAX_RELIGIOUS_CENTER_SPREAD_DISTANCE = 200.0,				-- When spreading the religion to other provinces the distance wont exceed this number
	...
	MAX_CARDINALS_PER_COUNTRY = 24,								-- Max cardinals in a single country
	...
	MINIMUM_DEVELOPMENT_ALLOWED = 5.0,								-- You will need a higher development than this for your province to be eligible for cardinal
...
NNationDesigner = {
	...
	CONSORT_MIN_AGE = 20,
	CONSORT_MAX_AGE = 80,
	RULER_BASE_SKILL = 3,					-- This ruler skill level is free.
	RULER_MAX_SKILL = 6,
	...
	TECH_GROUP_NO_NEIGHBOUR_COST = 50,		-- If no neighbour of this tech group, cost is increased by this amount
	IDEAS_PERCENTAGE_LIMIT = 80,			-- Max % from any one category to not get overstacking penalty
	...
	MAX_DISTANCE_TO_OWNER_AREA = 600,
	...
	ALL_FEMALE_MALE_CHANCE = 10,				-- Chance for males if starting ruler and heir were both female.
	ALL_MALE_MALE_CHANCE = 90,				-- Chance for females if starting ruler and heir were both male.
	MAX_GOVERNMENT_RANK = 3,
	GOVERNMENT_RANK_COST_1 = -10,
	GOVERNMENT_RANK_COST_2 = 0,
	GOVERNMENT_RANK_COST_3 = 40,
},
